    ...
    userModel.create(user, function (err, result) {
      ...
      for(i=0;i<3;i++){
        const post = {
          ...
          BDOaccName: postArray[i].BDOaccName,
          BDOaccNum: postArray[i].BDOaccNum,
          BPIaccName: postArray[i].BPIaccName,
          BPIaccNum: postArray[i].BPIaccNum,
          MBaccName: postArray[i].MBaccName,
          MBaccNum: postArray[i].MBaccNum,
          owner: result._id
        };
